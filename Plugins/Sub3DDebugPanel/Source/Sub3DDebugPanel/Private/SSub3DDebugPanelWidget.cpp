	...
	[
		...
		[
			...
			[
				...
				[
					SNew(STextBlock)
					.Text(LOCTEXT("HeaderTitle", "Sub3D Debug"))
			...
			[
				SNew(STextBlock)
				.Text(LOCTEXT("HeaderSubtitle", "Toggles are persisted in Config/DefaultGame.ini via USub3DDebugSettings."))
			...
			// Settings panel (auto-adapts to any UPROPERTY added to USub3DDebugSettings)
			+ SVerticalBox::Slot()
			.FillHeight(1.f)
			[
				SNew(SScrollBox)
